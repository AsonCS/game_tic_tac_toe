...
class Controller:
    ...
    __DEFAULT_HTML_ERROR_RESPONSE = (500, '<h1>Internal Error</h1>')
    __DEFAULT_JSON_ERROR_RESPONSE = (500, '{ }')
    ...
    def load_game_html(self) -> 'tuple[int,str]':
        ...
        try:
            ...
            print('load_game_html', e)
            return Controller.__DEFAULT_HTML_ERROR_RESPONSE
    ...
    def load_game_json(self) -> 'tuple[int,str]':
        ...
        try:
            ...
            return Controller.__DEFAULT_JSON_ERROR_RESPONSE
